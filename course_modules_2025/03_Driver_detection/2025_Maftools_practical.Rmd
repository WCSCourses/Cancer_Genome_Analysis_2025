...
```{r}
setwd("/home/manager/data/Driver_detection-20220823T163817Z-001/Driver_detection/")
```
...
We can also compare the genes we have identified with dndscv to other cohort (if they are also altered or not).

```{r}
tcgaDriverBP(BLCA, genes = c("TP53","PIK3CA","ARID1A", "KMT2D", "RB1"))
```
